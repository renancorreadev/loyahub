...
export function RemovePointsPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const pointsResponse = await axios.patch(`${apiURL}/points/remove`, {
        clientId,
        points: formData.points,
      });

      console.log(pointsResponse.data);
      alert('Pontos removido com sucesso!');
  ...
  return (
    <div>
      <Breadcrumb pageName="Remover Pontos" />
